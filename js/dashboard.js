...
function processFile(file) {
  // If a live Google Sheet sync is running, stop it — CSV takes over
  if (typeof disconnectSyncSoft === 'function' && window._syncPubUrl) {
    disconnectSyncSoft();
  }
  document.getElementById('loadingOverlay').classList.add('show');
...
function backToLanding() {
  // Always stop any live Google Sheet sync before leaving the dashboard
  if (typeof disconnectSyncSoft === 'function') disconnectSyncSoft();
